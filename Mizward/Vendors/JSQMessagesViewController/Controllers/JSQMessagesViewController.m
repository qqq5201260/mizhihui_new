...
//        cell.textView.text = [messageItem text];
        NSMutableAttributedString *one1 = [[NSMutableAttributedString alloc] initWithString:[messageItem text]];
        
        [one1 setAttributes:@{NSLinkAttributeName:[NSURL URLWithString:@"telprompt://023-67682893"],NSForegroundColorAttributeName :[UIColor blueColor],NSUnderlineStyleAttributeName : @(NSUnderlineStyleSingle | NSUnderlinePatternSolid)} range:[[messageItem text] rangeOfString:@"点击拨打热线"]];
        
        cell.textView.attributedText = one1;
