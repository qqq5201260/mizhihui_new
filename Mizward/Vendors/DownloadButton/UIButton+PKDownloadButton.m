...
{
    UIImage *backImage = [UIImage buttonBackgroundWithColor:[UIColor lightGrayColor]];
    [self setBackgroundImage:[backImage resizableImageWithCapInsets:UIEdgeInsetsMake(15.f, 15.f, 15.f, 15.f)]
                    forState:UIControlStateDisabled];
//    [self setBackgroundImage:[UIImage highlitedButtonBackgroundWithColor:[UIColor lightGrayColor]]
//                    forState:UIControlStateHighlighted];
}
