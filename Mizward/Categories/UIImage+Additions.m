...
//抗锯齿
//IOS7以上推荐 layer.allowsEdgeAntialiasing = true
- (UIImage *)antiAlias
{
    CGFloat border = 1.0f;
...
- (UIImage *)imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation(degreesToRadian(degrees));
    ...
    CGContextRotateCTM(bitmap, degreesToRadian(degrees));
