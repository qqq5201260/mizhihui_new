...
NSString *completeRPCURLPath = @"/srwebviewprogressproxy/complete";

const float SRInitialProgressValue = 0.1f;
const float SRInteractiveProgressValue = 0.5f;
const float SRFinalProgressValue = 0.9f;

@implementation SRWebProgress
{
...
- (void)startProgress
{
    if (_progress < SRInitialProgressValue) {
        [self setProgress:SRInitialProgressValue];
    }
}
...
- (void)incrementProgress
{
    ...
    float maxProgress = _interactive ? SRFinalProgressValue : SRInteractiveProgressValue;
