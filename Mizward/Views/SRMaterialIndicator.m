...
static NSString *kRingStrokeAnimationKey = @"SRMaterialIndicator.stroke";
static NSString *kRingRotationAnimationKey = @"SRMaterialIndicator.rotation";

@interface SRMaterialIndicator ()
@property (nonatomic, strong) CAShapeLayer *progressLayer;
@property (nonatomic, assign) BOOL isAnimating;
@end

@implementation SRMaterialIndicator
