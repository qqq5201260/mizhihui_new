...
#import "SRVehicleInfoViewController.h"
...
@interface SRVehicleInfoViewController ()<UIPageViewControllerDelegate, UIPageViewControllerDataSource, UIScrollViewDelegate>
...
@implementation SRVehicleInfoViewController
...
- (void)viewDidLoad {
    ...
    self.title = SRLocal(@"title_vehicle_info");
...
- (NSMutableArray *)detailVCs
{
    ...
    [self.vehicles enumerateObjectsUsingBlock:^(SRVehicleBasicInfo *obj, NSUInteger idx, BOOL *stop) {
        SRVehicleInfoDetailViewController *vc = [[SRVehicleInfoDetailViewController alloc] initWithVehicleBasicInfo:obj];
